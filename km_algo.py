...
def data_gen(num_samples, num_clusters, dim = 2):
	...
	plot_colors = ['#E69F00', '#56B4E9', '#F0E442', '#009E73', '#D55E00', '#D57800']
	...
	for i, mean in enumerate(means):
		...
		plt.plot(x_val, y_val, plot_colors[i],linestyle="None",marker='o')
...
def main():
	# Data generation
	X = data_gen(num_samples=600, num_clusters=6)	
